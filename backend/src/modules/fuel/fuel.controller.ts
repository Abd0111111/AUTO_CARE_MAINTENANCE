...
export class FuelController {
  ...
  async getUserFuel(
    ...
    const fuelRecords = await this.fuelService.getUserFuel(userId, page, size);
    return successResponse({
      data: {
        fuelRecords: fuelRecords.result,
        docCount: fuelRecords.docCount,
        pages: fuelRecords.pages,
        currentPage: fuelRecords.currentPage,
        limit: fuelRecords.limit,
      },
    });
  }
