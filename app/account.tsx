    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <InfoRow
            label="Engine"
            value={valueOrFallback(profile.engineCapacity ? `${profile.engineCapacity} CC` : '')}
          />
          <InfoRow
            label="Odometer"
            value={valueOrFallback(profile.odometerMileage ? `${profile.odometerMileage} km` : '')}
          />
        ...
        <View style={styles.card}>
          ...
          <InfoRow
            ...
            value={valueOrFallback(profile.lastOilChange ? `${profile.lastOilChange} km` : '')}
          />
          <InfoRow
            label="Last Tire Change"
            value={valueOrFallback(profile.lastTireChange ? `${profile.lastTireChange} km` : '')}
          />
